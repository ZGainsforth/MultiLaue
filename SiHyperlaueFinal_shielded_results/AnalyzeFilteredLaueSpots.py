...
def ComputeSpotEnergy(I, WtPct, rho, t, quiet=False):
    ...
    if not quiet:
        plt.figure()
        plt.plot(E,ApparentSpectrum[0,:], E,ApparentSpectrum[1,:], E,ApparentSpectrum[2,:], E,ApparentSpectrum[3,:])
        plt.legend(['No filter', 'One filter', 'Two filters', 'Three filters'])
    ...
    if not quiet:
        plt.figure()
        plt.plot(E,ApparentRatioSpectrum[0,:], E,ApparentRatioSpectrum[1,:], E,ApparentRatioSpectrum[2,:], E,ApparentRatioSpectrum[3,:])
        plt.legend(['No filter', 'One filter', 'Two filters', 'Three filters'])
